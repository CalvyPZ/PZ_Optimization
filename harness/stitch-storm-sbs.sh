...
drawtext=fontfile=$FONT:fontsize=34:fontcolor=0xb4b4b8:x=20:y=18:text='STOCK  (every optimization off, in-game cap 300)   71 fps mean, p99 67 ms, 42 frames over 33 ms'[l];\
...
drawtext=fontfile=$FONT:fontsize=34:fontcolor=0xb4b4b8:x=20:y=18:text='OPTIMIZED  (uncapped)   269 fps mean, p99 8.8 ms, 0 frames over 33 ms'[r];\
[l][r]hstack=inputs=2,drawbox=y=780:h=30:w=3840:color=black@0.75:t=fill,\
drawtext=fontfile=$FONT:fontsize=22:fontcolor=0x8a8a90:x=(w-text_w)/2:y=784:text='Project Zomboid B42.20  thunderstorm, 120 km/h, 5120x2160 max zoom, RTX 4090 / 9800X3D, no Steam  -  PZ_Optimization 2026-09-20',setparams=color_primaries=bt2020:color_trc=smpte2084:colorspace=bt2020nc:range=tv" \
