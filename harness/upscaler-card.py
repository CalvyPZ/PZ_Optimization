...
text(X0, H - PAD - 60, "Options > Optimizations > Upscaling: Upscaler, Upscaler quality (67 / 58 / 50 / 33 / 100 %), Explicit render scale, "
     "FSR 1.0 sharpening, DLSS model preset, Motion vectors for characters and vehicles. Applies on the next launch.", 12.5, INK2)
