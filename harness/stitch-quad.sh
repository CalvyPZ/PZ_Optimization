...
S60=$(run quad6-stock60-1);  O60=$(run quad6-opt60-1)      # runs: --launcher direct with Steam shut down (a live Steam overlay pins the GL thread: ~160 fps instead of 240)
