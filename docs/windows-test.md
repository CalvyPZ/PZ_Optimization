...
2026-09-23 release from `be1f28a` (parked cars spawn again: the decompiled `IsoChunk.AddVehicles_OnZone` filled one row of stalls per parking zone and chunk and gave the High car-spawn rate a flat 2 %; also the fish-per-spot hash in double like the jar, and the build-time bytecode audit of the overrides) is 44.0 MB, 421 manifest lines, sha256 `c3a1490074ec03f55bccd6467cc752340da37c13abac8777f0e339ff09d37bc4`, tag `win-b0bbce05d5-be1f28a`.
