...
| `media/dell-lowend-comparison.png` | generated by `harness/lowend-table.py` (the Workshop page's "New! Low-end hardware mode" image: stock vs profile on the Dell, dated; numbers typed in from results.md) |
