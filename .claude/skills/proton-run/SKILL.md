...
Properties > Compatibility (which removes the native depot) is Diego's decision. Do not do it.
...
native launcher JSON is stock (-Xmx3072m, ZGC), Proton dir holds Diego's tuned
